...
// Use a generic icon for Google since lucide doesn't have a brand icon for it
...
export const AuthModal: React.FC = () => {
    const { loginWithGithub, loginWithGoogle, isLoading, error } = useAuth();
    ...
    // If Firebase is restoring the session explicitly on mount, don't show the modal right away
